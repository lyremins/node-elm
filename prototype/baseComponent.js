...
export default class BaseComponent {
	constructor(){
		this.idList = ["chatGroup_id","wqState_id","airplenState_id","log_id",'chat_id','airplaneAmmo_id','airplaneCar_id','airplaneDevice_id','ammo_id','organiz_id','plan_id','subject_id','vehicle_id','device_id','ensure_id','equip_id','airplane_id','person_id','restaurant_id', 'food_id', 'order_id', 'user_id', 'address_id', 'cart_id', 'img_id', 'category_id', 'item_id', 'sku_id', 'admin_id', 'statis_id'];
