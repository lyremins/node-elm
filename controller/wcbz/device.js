...
class Device extends BaseComponent{
    ...
    async updateDevice(req, res, next){
		...
		form.parse(req, async (err, fields, files) => {
			...
			const {device_id,filed1, filed2,filed3,filed4,filed5,filed6,filed7,filed8,filed9,sy} = fields;
			try{
				let newData;
				newData = {filed1,filed2,filed3,filed4,filed5,filed6,filed7,filed8,filed9,sy}
